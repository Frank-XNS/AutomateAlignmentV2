...
def generate_dict(oov_file_name: str, original_dict_file_name: str, new_dict_file_name: str) -> None:
    ...
    if (file_exists(oov_file_name) and
        ...
        for oov in list_of_oovs:
            ...
            # The oov actually consists of 2 known words connected by an apostrophe
                ...
                if parts_found:
                    ...
                    print("%(word)s cannot be generated, please generate manually" % {'word': oov})
                    what_to_do[oov] = '?'

            # The oov actually consists of 2 known words connected by an hyphen
            elif "-" in oov:
                apostrophe_index = oov.index("-")
                first_part = oov[:apostrophe_index+1]
                second_part = oov[apostrophe_index+1:]
            ...
            # Completely new word
                ...
                char_to_sound = {'/': ' ', '_': " ",  'â': 'a', 'a': 'a', 'à': 'a', 'b': 'b', 'c': 'k', 'd': 'd', 'e': 'e', 'é': 'e', 'è': 'e', 'f': 'f',
                                 'ê': 'e', "ë": "E", 'g': 'g', 'h': '', 'i': 'i', 'ï': 'i', 'j': 'Z', 'k': 'k', 'l': 'l', 'm': 'm', 'n': 'n',
                                   'o': 'o', 'ô': 'o', 'p': 'p', 'q': 'k', 'r': 'R', 's': 's', 't': 't', 'u': 'y', 'v': 'v',
                                   'w': 'w', 'x': 'k s', 'y': 'j', 'z': 'z', 'œ':'neuf',
                                 '1':'un', '2':'d deux', '3':'t R w a','4':'k a t R','5':'cinq k','6':'s i s','7':'s E t','8':'huit i t', '9':'n neuf f','0':'z e R o'}
        ...
        #Finish and write the words to a new file
        new_dict_file_list = []
